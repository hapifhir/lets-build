...
public class CsvDataUploader_ValidateWithHapiValidationClasses {

  private static final Logger ourLog = LoggerFactory.getLogger(
      CsvDataUploader_ValidateWithHapiValidationClasses.class);
